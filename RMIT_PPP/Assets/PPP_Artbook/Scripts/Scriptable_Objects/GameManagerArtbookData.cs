...
{
    [CreateAssetMenu(fileName = "GameManagerArtbook_Data", menuName = "Managers/GameManagerArtbookData")]
    public class GameManagerArtbookData : ScriptableObject
    {
        #region Public Variables
        [Space, Header("Enums")]
        public GameState currState = GameState.Menu;
        public enum GameState { Menu, Intro, Game, Paused, Outro };
        #endregion
